...
<body>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b47cc59ad7a7b09cf4b9ca38e849df19&libraries=clusterer"></script> <!--마커 클러스터러 :  &libraries=clusterer -->
